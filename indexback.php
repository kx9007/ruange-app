  ...
  <div class="layui-container">
    ...
    <div class="house-banner layui-form">
      <a class="banner" href="index.html">
        <img src="src/static/img/banner.png" alt="家居商城">
      </a>
...
<!--    <div carousel-item>-->
<!--      <div><img src="src/static/img/banner.jpg"></div>-->
<!--      <div><img src="src/static/img/banner.jpg"></div>-->
<!--    </div>-->
<!--  </div>-->
<!--</div>-->
...
<div class="layui-container">
  <div class="hot-cate">
    ...
    <div class="layui-row">
      <div class="layui-col-xs4 cateFir cate">
        <a href="list.html">
          <img src="https://img.btstu.cn/api/images/5e82f63d29178.jpg">
          <div>
            <p>家居用品</p>
            <span>18元起</span>
          </div>
      ...
      <div class="layui-col-xs4 cateSec cate">
        <a href="list.html">
          <img src="src/static/img/home_img2.png">
          <div>
            <p>小家电</p>
            <span>59元起</span>
          </div>
      ...
      <div class="layui-col-xs4 cateThir cate">
        <a href="list.html">
          <img src="src/static/img/home_img3.png">
          <div>
            <p>洗护用品</p>
            <span>18元起</span>
          </div>
  ...
  <div class="hot-sell">
    ...
    <div class="layui-row layui-col-space20">
      <a class="layui-col-xs3 text" onclick="layer.open({
                type: 2,
                title: false,
                closeBtn: 1,
                shade: false,
                area: ['70vw', '520px'],
                content: 'http://app.kxlove.top/download.php?lx=1&id=3f61c90529d306c40ab78a87e11d2516'
            });">
        <div><img src="src/static/img/home_img4.jpg"></div>
        <p>一盏好看的台灯</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img5.jpg"></div>
        <p>时尚瓷碗7件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img6.jpg"></div>
        <p>智能电吹风</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img7.jpg"></div>
        <p>一盏好看的台灯</p>
        <p class="price">￥200</p>
      </a>
    </div>
  ...
  <div class="hot-sell">
    ...
    <div class="layui-row layui-col-space20">
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img8.jpg"></div>
        <p>蒂芙尼蓝化妆刷</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img9.jpg"></div>
        <p>玻璃洗漱三件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img10.jpg"></div>
        <p>清洁力强劲浴球</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img11.jpg"></div>
        <p>瘦脸仪</p>
        <p class="price">￥200</p>
      </a>
    </div>
...
<div class="layui-container">
  <div class="hot-sell">
    ...
    <div class="layui-row layui-col-space20">
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img12.jpg"></div>
        <p>森系小清新四件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img13.jpg"></div>
        <p>森系小清新四件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img14.jpg"></div>
        <p>森系小清新四件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="src/static/img/home_img15.jpg"></div>
        <p>森系小清新四件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
...
<div class="layui-fulid" id="champ">
  <div class="layui-row">
    <a href="list.html" class="layui-col-xs3">
      <img src="src/static/img/home_img16.jpg">
    </a>
    <a href="list.html" class="layui-col-xs6">
      <img src="src/static/img/home_img17.jpg">
    </a>
    <a href="list.html" class="layui-col-xs3">
      <img src="src/static/img/home_img20.jpg">
    </a>
    <a href="list.html" class="layui-col-xs3">
      <img src="src/static/img/home_img18.jpg">
    </a>
    <a href="list.html" class="layui-col-xs3">
      <img src="src/static/img/home_img19.jpg">
    </a>
    <a href="list.html" class="layui-col-xs3">
      <img src="src/static/img/home_img21.jpg">
    </a>
  </div> 
</div>
